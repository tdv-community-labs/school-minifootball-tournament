...
import { ARCHIVE_YEARS, ARCHIVE_CLASSES, ARCHIVE_MATCHES, ARCHIVE_PLAYERS } from './archiveData.js?v=20260912_0070';
import { isMatchDivision, getDivisionsForYear } from './i18n.js?v=20260912_0120';
import { auditTournamentData, repairTournamentData, startBackgroundSelfHealing } from './selfHealing.js?v=20260912_0070';
...
setTimeout(() => {
  try {
    if (typeof startBackgroundSelfHealing === 'function') {
      startBackgroundSelfHealing();
    }
  } catch (e) {
    console.warn('Background self-healing deferred error:', e);
  }
}, 300);
